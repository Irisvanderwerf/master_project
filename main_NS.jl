...
load_path = "trained_models/final_model.bson";  # Set to `nothing` to initialize instead

# Call the function
ps_drift, st_drift, opt_drift, ps_denoiser, st_denoiser, opt_denoiser, model_name = initialize_or_load_model(model_name, is_gaussian, load_path);
...
t = 0.0f0; # Initial time t_0
dt = 2.0f-4; # Time step Δt
nt = 5; # Number of time steps (number of training and test samples)
