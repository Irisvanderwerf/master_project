...
# t = 0.0f0; # Initial time t_0
# dt = 2.0f-4; # Time step Δt
# nt = 100; # Number of time steps (number of training and test samples)
...
#         title_closure = @sprintf("vorticity closure, t=%.3f")
...
#         println("Error between model and ground truth at t = ", t, ": ", mean(error_map))
#     end
# end